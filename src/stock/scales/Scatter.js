...
(function() {
  ...
  proto['ul_getTicks'] = proto.getTicks;//jb
  proto['ul_getMinimumIndex'] = proto.getMinimumIndex;//jb
  proto['ul_getMaximumIndex'] = proto.getMaximumIndex;//jb
  proto['ul_getMajorIntervalUnit'] = proto.getMajorIntervalUnit;//jb
  proto['ul_getMajorIntervalUnitCount'] = proto.getMajorIntervalUnitCount;//jb
  proto['ul_getMinorIntervalUnit'] = proto.getMinorIntervalUnit;//jb
  proto['ul_getMinorIntervalUnitCount'] = proto.getMinorIntervalUnitCount;//jb
  proto['ul_isMissing'] = proto.isMissing;//jb
  proto['ul_alignByIndex'] = proto.alignByIndex;//jb
  proto['ul_transformInternal'] = proto.transformInternal;//jb
  proto['ul_transformAligned'] = proto.transformAligned;//jb
  proto['ul_setAutoFullRange'] = proto.setAutoFullRange;//jb
  proto['ul_setCurrentRange'] = proto.setCurrentRange;//jb
  proto['ul_getKeyByIndex'] = proto.getKeyByIndex;//jb
  proto['ul_getIndexByKey'] = proto.getIndexByKey;//jb
})();
