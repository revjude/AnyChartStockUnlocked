goog.provide('anychart.core.drawers.HollowCandles');
...
/**
 * HollowCandles drawer.
 * @param {anychart.core.series.Base} series
 * @constructor
 * @extends {anychart.core.drawers.Base}
 */
anychart.core.drawers.HollowCandles = function(series) {
  anychart.core.drawers.HollowCandles.base(this, 'constructor', series);
};
goog.inherits(anychart.core.drawers.HollowCandles, anychart.core.drawers.Base);
anychart.core.drawers.AvailableDrawers[anychart.enums.SeriesDrawerTypes.HOLLOWCANDLES] = anychart.core.drawers.HollowCandles;


/** @inheritDoc */
anychart.core.drawers.HollowCandles.prototype.type = anychart.enums.SeriesDrawerTypes.HOLLOWCANDLES;


/** @inheritDoc */
anychart.core.drawers.HollowCandles.prototype.flags = (
...
/** @inheritDoc */
anychart.core.drawers.HollowCandles.prototype.requiredShapes = (function() {
  var res = {};
...
/** @inheritDoc */
anychart.core.drawers.HollowCandles.prototype.yValueNames = (function () { return ['open', 'high', 'low', 'close']; })();


/** @inheritDoc */
anychart.core.drawers.HollowCandles.prototype.valueFieldName = 'close';


/** @inheritDoc */
anychart.core.drawers.HollowCandles.prototype.drawSubsequentPoint = function(point, state) {
